...
type
  ...
  TBot = class
    ...
    eps: double;        // точность
    GetFitness: TFunc;                // рассчитать приспособленность
    constructor Create(_Gens: TArrOfDouble; Func: TFunc); overload;
    constructor Create(NGens: integer; maxV, minV: TArrOfDouble; _target, _eps: double; Func: TFunc); overload;
  ...
  TPopulation = class
     ...
     Pobeditel: TBot;
     constructor Create(CounBots, _MaxAge, NGens: integer; maxV, minV: TArrOfDouble; _NGood: integer; _target, _eps: double; Func: TFunc);
...
constructor TBot.Create(NGens: integer; maxV, minV: TArrOfDouble; _target, _eps: double; Func: TFunc);
var
  i: integer;
  x: double;
begin
...
constructor TPopulation.Create(CounBots, _MaxAge, NGens: integer; maxV, minV: TArrOfDouble; _NGood: integer; _target, _eps: double; Func: TFunc);
var
  i: integer;
begin
